...
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC ABS, DLOG, MAX, MIN, REAL, IDNINT, DSIGN, DSQRT
*     ..
*     .. External Functions ..
...
*
      SCALEM  = ONE / DSQRT(REAL(M)*REAL(N))
      NOSCAL  = .TRUE.
      GOSCAL  = .TRUE.
      DO 1874 p = 1, N
         AAPP = ZERO
...
*           more conservative    <=> CONDR1 .LT. DSQRT(REAL(N))
*
            COND_OK = DSQRT(REAL(NR))
