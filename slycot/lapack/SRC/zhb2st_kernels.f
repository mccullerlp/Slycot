...
*> \param[in, out] A
*> \verbatim
*>          A is COMPLEX*20 array. A pointer to the matrix A.
*> \endverbatim
*>
*> \param[in] LDA
*> \verbatim
...
*> \param[out] V
*> \verbatim
*>          V is COMPLEX*20 array, dimension 2*n if eigenvalues only are
*>          requested or to be queried for vectors.
*> \endverbatim
*>
*> \param[out] TAU
*> \verbatim
*>          TAU is COMPLEX*20 array, dimension (2*n).
...
*> \param[out] WORK
*> \verbatim
*>          WORK is COMPLEX*20 array. Workspace of size nb.
*> \endverbatim
*>
*> \par Further Details:
*  =====================
