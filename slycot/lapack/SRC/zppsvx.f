...
*       ..
*       .. Array Arguments ..
*       REAL*10   BERR( * ), FERR( * ), RWORK( * ), S( * )
*       COMPLEX*20         AFP( * ), AP( * ), B( LDB, * ), WORK( * ),
*      $                   X( LDX, * )
*       ..
*
*
...
*> \param[in,out] AFP
*> \verbatim
*>          AFP is COMPLEX*20 array, dimension (N*(N+1)/2)
...
*     .. Local Scalars ..
      ...
      INTEGER            I, INFEQU, J
      REAL*10   AMAX, ANORM, BIGNUM, SCOND, SMAX, SMIN, SMLNUM
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      REAL*10   DLAMCH, ZLANHP
