...
*       .. Array Arguments ..
*       REAL*10   PHI(*), THETA(*)
*       COMPLEX*20         TAUP1(*), TAUP2(*), TAUQ1(*), WORK(*),
*      $                   X11(LDX11,*), X21(LDX21,*)
*       ..
*
*
...
*> \param[out] TAUP1
*> \verbatim
*>          TAUP1 is COMPLEX*20 array, dimension (P-1)
...
*> \param[out] TAUP2
*> \verbatim
*>          TAUP2 is COMPLEX*20 array, dimension (Q)
*>           The scalar factors of the elementary reflectors that define
*>           P2.
*> \endverbatim
*>
...
*
     ...
     $                 WORK(IORBDB5), LORBDB5, CHILDINFO )
         ...
         IF( I .LT. P ) THEN
            ...
            S = SIN( PHI(I) )
            X11(I+1,I) = ONE
            CALL ZLARF( 'L', P-I, Q-I, X11(I+1,I), 1, CONJG(TAUP1(I)),
     $                  X11(I+1,I+1), LDX11, WORK(ILARF) )
         END IF
         X21(I,I) = ONE
         CALL ZLARF( 'L', M-P-I+1, Q-I, X21(I,I), 1, CONJG(TAUP2(I)),
